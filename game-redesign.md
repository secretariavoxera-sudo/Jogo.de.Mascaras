...
- 🎭 **Infiltrado** - Pretende ser Defensor mas é Contestador (engana)

**Dinâmica:** Defensor e Infiltrado vs Contestador + Mediador
...
- 🕵️ **Testemunha Falsa** - Mente para confundir
...
- 📰 **Jornalista** - Tenta descobrir a verdade
...
4. **Infiltrado** - Focado no twist
5. **Jogo da Verdade** - Simples e claro
6. **Conspiração** - Dramático
7. **Tribunal Secreto** - Formal e interessante
...
4. **Jogo de Máscaras** - Teatral, sobre papéis
5. **Confissão** - Direto e intrigante
6. **O Segredo** - Simples e intrigante
7. **Verdade Velada** - Poético

/**
 * Hook para gerenciar efeitos sonoros do jogo "Jogo de Máscaras"
 * Fornece funções para tocar aplausos e vaias durante a votação
 */

import { useCallback, useRef } from "react";

// Singleton para o AudioContext para evitar exaustão de recursos
...
function getAudioContext() {
  ...
  // Se o contexto estiver suspenso (comum em navegadores que bloqueiam autoplay), tentamos retomá-lo

...
export const THEME_PACKS: ThemePack[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      "A Pixar é melhor que a Disney Animation?",
      "O Batman do Christian Bale é o melhor de todos?",
      "Stranger Things deveria ter acabado na 1ª temporada?",
      "Friends é uma série sobrevalorizada?",
      "O streaming de música (Spotify) prejudica os artistas?",
      "Os vilões da Disney são melhores que os príncipes?",
      "O Senhor dos Anéis é a melhor trilogia do cinema?",
      "O TikTok está a destruir a indústria musical?",
      "Filmes de terror modernos são melhores que os clássicos?",
      "Shrek é o melhor filme de animação de sempre?",
      "Ver filmes no telemóvel estraga a experiência?",
      "A Marvel deveria fazer uma pausa nos cinemas?",
      "Séries com episódios semanais são melhores que maratonas?",
      "O CGI (efeitos visuais) está a tirar a alma aos filmes?",
      "Jogos online são melhores que jogos de história (single player)?",
      "A Netflix foca-se mais na quantidade do que na qualidade?",
      "Rock 'n' Roll morreu ou apenas evoluiu?",
      "Personagens secundários são muitas vezes melhores que os protagonistas?",
      "Filmes de Natal podem ser vistos o ano inteiro?",
      "Reações no YouTube são conteúdo original?",
      "O Homem-Aranha do Tom Holland é o melhor do MCU?",
      "Sitcoms com risadas gravadas perderam a piada?",
      "Adaptar videojogos para o cinema quase nunca corre bem?",
      "O Oscar ainda é relevante para o público?",
      "É possível separar a obra do artista?",
      "O 3D no cinema foi apenas uma moda passageira?",
      "As redes sociais mataram a privacidade das celebridades?",
      "Bandas de K-Pop são o novo fenómeno mundial?",
      "Merchandising de filmes é desperdício de plástico?",
      "O final de Lost foi incompreendido ou foi mesmo mau?",
    ],
  },
  {
    id: "ousado",
